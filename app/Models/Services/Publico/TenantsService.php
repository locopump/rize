...

{
    ...
    public function __construct(TenantsInterface $tenants)
    {
    ...
    public function getRow(int $id)
    {
        ...
        try {
            $tenants = $this->tenants->getRow($id);
    ...
    public function delete(int $id)
    {
        ...
        try {
            $affected_rows = $this->tenants->delete($id);
            ...
            Log::critical('Delete Row - Tenants',
                ['request' => $response, 'exception' => $e->getMessage()]);
        } catch (Exception $e) {
            $response = [
                'success' => false,
