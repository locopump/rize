...

{
    ...
    public function getAll()
    {
        ...
        try {
            ...
            Log::critical('Listado de las Likes',
            ...
            Log::alert('Listado de las Likes',
                ['request' => $response, 'exception' => $e->getMessage()]);
        }
    ...
    public function delete(int $id)
    {
        ...
        try {
            $affected_rows = $this->likes->delete($id);
    ...
    public function getLikesByGender()
    {
        ...
        try {
            ...
            Log::critical('Listado de total de likes por género',
                ['request' => $response, 'exception' => $e->getMessage()]);
        } catch (Exception $e) {
            $response = [
                'success' => false,
            ...
            Log::alert('Listado de total de likes por género',
                ['request' => $response, 'exception' => $e->getMessage()]);
        }
    ...
    public function getLikesByTenant()
    {
        ...
        try {
            ...
            Log::critical('Listado de total de likes por locatario',
                ['request' => $response, 'exception' => $e->getMessage()]);
        } catch (Exception $e) {
            $response = [
                'success' => false,
            ...
            Log::alert('Listado de total de likes por locatario',
                ['request' => $response, 'exception' => $e->getMessage()]);
        }
    ...
    public function getLikesByBrand()
    {
        ...
        try {
            ...
            Log::critical('Listado de total de likes por marca',
                ['request' => $response, 'exception' => $e->getMessage()]);
        } catch (Exception $e) {
            $response = [
                'success' => false,
            ...
            Log::alert('Listado de total de likes por marca',
                ['request' => $response, 'exception' => $e->getMessage()]);
        }
